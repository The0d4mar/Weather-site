...
export {citites_obj, export_number}


const api = '20ea2c25f540f9908dfb1d75424a6277';
let long;
let lat;
let elem;
let export_number;
...
form.addEventListener('click', function(event){
  ...
  if(cities_available.indexOf(chose_city ) != -1){
    cityAdder(cities_avalibal_info[chose_city], chose_city);
    input.value = '';
  }
